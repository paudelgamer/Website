...
export default function DataFilter(data) {
  ...
  const policies = [
    ...
    { policy: 10, min: 500000, max: 15000000, minEntry: 18, maxEntry: 55, minYears: 5, maxYears: 25, exactTerms: [15, 20, 25] },
    { policy: 11, min: 400000, max: 12000000, minEntry: 18, maxEntry: 55, minYears: 5, maxYears: 25, exactTerms: [15, 20] },
    { policy: 12, min: 600000, max: 16000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 25, exactTerms: [15, 20, 25] },
    { policy: 13, min: 350000, max: 10000000, minEntry: 18, maxEntry: 55, minYears: 5, maxYears: 20, exactTerms: [15, 20] },
    { policy: 14, min: 450000, max: 13000000, minEntry: 18, maxEntry: 55, minYears: 5, maxYears: 25, exactTerms: [15, 20, 25] },
    { policy: 15, min: 500000, max: 14000000, minEntry: 18, maxEntry: 55, minYears: 5, maxYears: 20, exactTerms: [15, 20] },
    { policy: 16, min: 400000, max: 12000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
    { policy: 17, min: 250000, max: 9000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
    { policy: 18, min: 350000, max: 10000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
    { policy: 19, min: 300000, max: 8500000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
    { policy: 20, min: 500000, max: 12000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
    { policy: 21, min: 600000, max: 13000000, minEntry: 18, maxEntry: 55, minYears: 10, maxYears: 55 },
  ];
